...
inertia = []
#Inertia is a measure of how well the data points fit within their assigned clusters.
#It’s also known as the “within-cluster sum of squared errors (WCSS)”. Here we are calculating value of inertia for different values of k
K = range(1, 11)
...
# The Silhouette Score is a metric used to measure how well-separated and well-formed the clusters are in your data.
# It tells you how similar a data point is to its own cluster compared to other clusters.
